"""
Django settings for liveledger project.
...
WSGI_APPLICATION = 'liveledger.wsgi.application'
...
EMAIL_DOMAIN_ADDRESS = os.environ.get('MAILJET_FROM_EMAIL')
